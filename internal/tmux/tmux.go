...
// Uses the default tmux server (empty socket name).
func NewTmux() *Tmux {
	return &Tmux{socketName: GetDefaultSocket()}
}
...
// See: https://github.com/colbymchenry/devpit/issues/1219
...
func (t *Tmux) NudgeSessionWithOpts(session, message string, opts NudgeOpts) error {
	...
	if agentPane, err := t.FindAgentPane(session); err == nil && agentPane != "" {
		...
		// not necessarily this session's. (gt-ec1)
...
// uses a regular space. See https://github.com/colbymchenry/devpit/issues/1387.
